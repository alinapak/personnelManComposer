...
foreach ($employees as $employee) {
   print("<tr>
            ...
            <td> " . ($employee->project_id ? $employee->project_id->getProjName() : '') . "</td>
            <td>
...
if (!isset($_POST['updateEm'])) {
   ...
   print("<select id='projId' name='projId' onfocus='this.size=5'>
               <option value='NULL'>--Be projekto--</option>");

   foreach ($projects as $project) {
      print("<option value='" . htmlspecialchars($project->getId()) . "'>" . htmlspecialchars($project->getProjName()) . "</option>");
   }
